...
import {Menu, Button, Form, Divider, Modal} from 'semantic-ui-react'
import Slider, { Range } from 'rc-slider';
import 'rc-slider/assets/index.css';
import _ from 'lodash';


class SidebarFormMobile extends Component {
  ...
  render() {
    ...
    return(
      ...
      <Modal trigger={<Button className="mobile_filter_btn" icon="filter" onClick={this.handleOpen}></Button>} open={this.state.modalOpen} onClose={this.handleClose} >
      ...
      <Form loading={this.props.isLoading} >
        ...
        <Form.Group grouped>
          ...
          <h3>Pris:</h3>
            <p style={{display:"inline-block", width:"50%"}}>{this.state.price[0] + "kr"}</p><p style={{display:"inline-block", width:"50%", textAlign:"right"}}>{this.state.price[1] + "kr"}</p>
        ...
        <Form.Group grouped>
          ...
          <div style={{width:"90%", margin:"auto"}}>
          <h3>Abv:</h3>
            <p style={{display:"inline-block", width:"50%"}}>{this.state.abv[0]}</p><p style={{display:"inline-block", width:"50%", textAlign:"right"}}>{this.state.abv[1]}</p>
...
export default SidebarFormMobile;
